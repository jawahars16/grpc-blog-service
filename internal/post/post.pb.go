...
var file_internal_post_post_proto_rawDesc = []byte{
	...
	0x6f, 0x73, 0x74, 0x32, 0x83, 0x01, 0x0a, 0x04, 0x42, 0x6c, 0x6f, 0x67, 0x12, 0x41, 0x0a, 0x0a,
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x10, 0x5a, 0x0e, 0x2f, 0x69, 0x6e,
	0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x2f, 0x70, 0x6f, 0x73, 0x74, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
...
var file_internal_post_post_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
...
var file_internal_post_post_proto_depIdxs = []int32{
	5, // 0: post.Post.publication_date:type_name -> google.protobuf.Timestamp
	5, // 1: post.CreatePostRequest.publication_date:type_name -> google.protobuf.Timestamp
	0, // 2: post.CreatePostResponse.post:type_name -> post.Post
	0, // 3: post.GetPostResponse.post:type_name -> post.Post
	1, // 4: post.Blog.CreatePost:input_type -> post.CreatePostRequest
	3, // 5: post.Blog.GetPost:input_type -> post.GetPostRequest
	2, // 6: post.Blog.CreatePost:output_type -> post.CreatePostResponse
	4, // 7: post.Blog.GetPost:output_type -> post.GetPostResponse
