...
var file_internal_post_post_proto_rawDesc = []byte{
	...
	0x04, 0x70, 0x6f, 0x73, 0x74, 0x32, 0x49, 0x0a, 0x04, 0x42, 0x6c, 0x6f, 0x67, 0x12, 0x41, 0x0a,
	...
	0x42, 0x10, 0x5a, 0x0e, 0x2f, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x2f, 0x70, 0x6f,
...
var file_internal_post_post_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
...
var file_internal_post_post_proto_depIdxs = []int32{
	3, // 0: post.Post.publication_date:type_name -> google.protobuf.Timestamp
	3, // 1: post.CreatePostRequest.publication_date:type_name -> google.protobuf.Timestamp
	0, // 2: post.CreatePostResponse.post:type_name -> post.Post
	1, // 3: post.Blog.CreatePost:input_type -> post.CreatePostRequest
	2, // 4: post.Blog.CreatePost:output_type -> post.CreatePostResponse
